...
<html>
<head>
	<title>Country Inn | Invoice</title>
	<style>
p {
  color: black;
  font-size: 14px;
...
// email stuff
$to = $email;
$from = "countryinn04@gmail.com"; 
$subject = "Country Inn - Invoice"; 
$message = "<P>Please find attached Tax Invoice for your booking.<br><br>Thanks and Regards,<br>COUNTRY INN</P>";
